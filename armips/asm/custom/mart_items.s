...
/* const u16 _020FBA54[] = {ITEM_X_ATTACK, ITEM_X_DEFENSE, 0xFFFF}; */
...
/* const u16 _020FBA5A[] = {ITEM_X_DEFENSE, ITEM_QUICK_BALL, 0xFFFF}; */

/* const u16 _020FBA60[] = {ITEM_X_DEFENSE, ITEM_HEAL_BALL, ITEM_NET_BALL, 0xFFFF}; */
...
/* const u16 _020FBA68[] = {ITEM_X_DEFENSE, ITEM_X_ATTACK, ITEM_X_SP_DEF, 0xFFFF}; */
/* const u16 _020FBA70[] = {ITEM_X_DEFENSE, ITEM_X_SPECIAL, ITEM_QUICK_BALL, 0xFFFF}; */

/* const u16 _020FBA78[] = {ITEM_X_ATTACK, ITEM_HEAL_BALL, ITEM_NET_BALL, 0xFFFF}; */
...
/* const u16 _020FBA80[] = {ITEM_HEAL_BALL, ITEM_NET_BALL, ITEM_X_SPECIAL, 0xFFFF}; */
/* const u16 _020FBA88[] = {ITEM_LOADED_DICE, ITEM_HEAL_BALL, ITEM_NET_BALL, 0xFFFF}; */
/* const u16 _020FBA90[] = {ITEM_X_ATTACK, ITEM_X_SPECIAL, ITEM_QUICK_BALL, 0xFFFF}; */
/* const u16 _020FBA98[] = {ITEM_X_ATTACK, ITEM_X_SPECIAL, ITEM_QUICK_BALL, 0xFFFF}; */
/* const u16 _020FBAA0[] = {ITEM_X_ATTACK, ITEM_NEST_BALL, ITEM_QUICK_BALL, 0xFFFF}; */
/* const u16 _020FBAA8[] = {ITEM_X_ATTACK, ITEM_NET_BALL, ITEM_HEAL_BALL, 0xFFFF}; */
/* const u16 _020FBAB0[] = {ITEM_X_SP_DEF, ITEM_HEAL_BALL, ITEM_NET_BALL, 0xFFFF}; */
/* const u16 _020FBAB8[] = {ITEM_TINYMUSHROOM, ITEM_POKE_BALL, ITEM_POTION, 0xFFFF}; */
/* const u16 _020FBAC0[] = {ITEM_HEAL_BALL, ITEM_NEST_BALL, ITEM_X_SPECIAL, ITEM_QUICK_BALL, 0xFFFF}; */
...
/* const u16 _020FBB16[] = {ITEM_POKE_DOLL, ITEM_FRESH_WATER, ITEM_SODA_POP, ITEM_LEMONADE, ITEM_REPEL, ITEM_HEART_SCALE, 0xFFFF}; */
...
/* const u16 _020FBBB4[] = {ITEM_X_SPEED, ITEM_X_ATTACK, ITEM_X_DEFENSE, ITEM_GUARD_SPEC_, ITEM_DIRE_HIT, ITEM_X_ACCURACY, ITEM_X_SPECIAL, ITEM_X_SP_DEF, 0xFFFF}; */
/* const u16 _020FBBC6[] = {ITEM_X_SPEED, ITEM_X_ATTACK, ITEM_X_DEFENSE, ITEM_GUARD_SPEC_, ITEM_DIRE_HIT, ITEM_X_ACCURACY, ITEM_X_SPECIAL, ITEM_X_SP_DEF, 0xFFFF}; */
...
/* const u16 _020FBBD8[] = {ITEM_GREAT_BALL, ITEM_SUPER_POTION, ITEM_HYPER_POTION, ITEM_FULL_HEAL, ITEM_HEART_SCALE, ITEM_SUPER_REPEL, ITEM_REVIVE, ITEM_RARE_CANDY, 0xFFFF}; */
...
/* const u16 _020FBC1A[] = {ITEM_POKE_BALL, ITEM_GREAT_BALL, ITEM_ULTRA_BALL, ITEM_ESCAPE_ROPE, ITEM_POKE_DOLL, ITEM_REPEL, ITEM_SUPER_REPEL, ITEM_MAX_REPEL, ITEM_LOADED_DICE, ITEM_LIFE_ORB, ITEM_FLAME_ORB, ITEM_TOXIC_ORB, 0xFFFF}; */
...
/* const u16 _020FBC4E[] = {ITEM_POKE_BALL, ITEM_GREAT_BALL, ITEM_ULTRA_BALL, ITEM_ESCAPE_ROPE, ITEM_POKE_DOLL, ITEM_REPEL, ITEM_SUPER_REPEL, ITEM_MAX_REPEL, ITEM_LOADED_DICE, ITEM_LIFE_ORB, ITEM_FLAME_ORB, ITEM_TOXIC_ORB, 0xFFFF}; */
