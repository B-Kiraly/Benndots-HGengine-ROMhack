...
u8 TypeEffectivenessTable[][3] =
{
...
#if FAIRY_TYPE_IMPLEMENTED == 1
    { TYPE_ROCK, TYPE_FAIRY, 0x05 },
#endif
    { TYPE_BUG, TYPE_BUG, 0x14 },
    ...
    { TYPE_BUG, TYPE_ROCK, 0x05 },
    { TYPE_GHOST, TYPE_GHOST, 0x14 },
    { TYPE_GHOST, TYPE_PSYCHIC, 0x14 },
    { TYPE_GHOST, TYPE_FIGHTING, 0x14 },
    { TYPE_GHOST, TYPE_ICE, 0x05 },
    ...
    { TYPE_STEEL, TYPE_GROUND, 0x05 },
    { TYPE_STEEL, TYPE_WATER, 0x05 },
    { TYPE_STEEL, TYPE_GHOST, 0x05 },

#if FAIRY_TYPE_IMPLEMENTED == 1
    { TYPE_FAIRY, TYPE_GHOST, 0x14 },
    { TYPE_FAIRY, TYPE_DRAGON, 0x14 },
    { TYPE_FAIRY, TYPE_DARK, 0x14 },
    { TYPE_FAIRY, TYPE_POISON, 0x14 },
    { TYPE_FAIRY, TYPE_STEEL, 0x05 },
    { TYPE_FAIRY, TYPE_GRASS, 0x05 },
    { TYPE_FAIRY, TYPE_FLYING, 0x05 },
    { TYPE_FAIRY, TYPE_BUG, 0x05 },
#endif
